package webdrivermanager.remotewebdriver;
...
public abstract class LambdaTestScenario
        implements AfterAWebdriverScenario, BeforeAWebdriverScenario {

  @Override
  public void apply(
          EnvironmentVariables environmentVariables, TestOutcome testOutcome, WebDriver driver) {
      ...
      URI uri =
              new URI(
                      "https://"
                              ...
                              + ":"
                              + accessKey
                              + "@api.lambdatest.com/automation/api/v1/sessions/"
                              + sessionId);
